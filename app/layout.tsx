        ...
        <div className="app-container">
          <aside className="sidebar">
            ...
            <nav className="nav-menu">
              ...
              <Link href="/announcements" className="nav-item">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <Link href="/dissemination" className="nav-item">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <Link href="/diet" className="nav-item">
                ...
                <span>Signify Diet</span>
              </Link>

              <Link href="/concerns" className="nav-item">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <div style={{ marginTop: "auto", fontSize: "0.8rem", color: "var(--muted)", textAlign: "center" }}>
